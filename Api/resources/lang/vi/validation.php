...
return [
    ...
    'attributes'           => [
        ...
        'student_year'          => 'sinh viên năm',
        'nation'                => 'dân tộc',
        'religion'              => 'tôn giáo',
        'CCCD'                  => 'căn cước công dân',
        'date_range'            => 'ngày cấp',
        'issued_by'             => 'nơi cấp',
        'student_object'        => 'dối tượng',
        'school'                => 'tên trường',
        'role_name'             => 'tên chức vụ',
        'role_desc'             => 'mô tả chức vụ',
        'permission_id'         => 'mã quyền',
        'role_id'               => 'mã chức vụ',
        'date_start'            => 'thời gian bắt đầu',
        'date_end'              => 'thời gian kết thúc',
        'fathername'            => 'tên của bố',
        'mothername'            => 'tên của mẹ',
        'address_relative'      => 'địa chỉ thân nhân',
        'phone_relative'        => 'điện thoại thân nhân',
        'periodic'              => 'định kỳ',
        'reminder'              => 'nhắc',
        'user_undertake_id'     => 'Id người dùng được giao',
        'user_create_id'        => 'Id người dùng tạo',
        'date_present'          => "thời gian hiện tại",
        'status'                => 'trạng thái',
        'project_id'                => 'dự án',
        'collection_date'                => 'ngày thu',
        'user_id'                => 'người dùng',
        'amount_of_money'                => 'tổng số tiền',
        'payment_type'                => 'hình thức thanh toán',
        'note'              => 'ghi chú',
        'receipt_reason_id'              => 'lý do thu',

        'request_type'                => 'kiểu tương tác',
        'student_id'              => 'sinh viên',
        'staff_id'              => 'nhân viên',
        'numberOfBed'              => 'số giường ngủ',
        'type_announce_id' => 'Loại thông báo',
        'unit_asset_id' => 'Đơn vị tài sản',
        ...
        'project_service_id' => 'Dịch vụ dự án',
        'priority' => 'Độ ưu tiên',
        'total_area' => 'Diện tích',
        'unit_price' => 'Đơn giá',
        'hotline' => 'Số điện thoại',
        'cycle_collect' => 'Chu kỳ thu',
        'extension_time' => 'Ngày gia hạn',
        'price_deposit' => 'Giá cọc',
        'number_bed' => 'Số giường',
        'room_type_id' => 'Loại phòng',
        'index_water' => 'Chỉ số nước',
        'index_electric' => 'Chỉ số điện'
    ],
];
