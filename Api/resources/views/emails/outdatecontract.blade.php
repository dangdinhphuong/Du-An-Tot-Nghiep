...
<body class="antialiased">
    <div class="">
        <div class="aHl"></div>
        <div id=":ot" tabindex="-1"></div>
        <div id=":pk" class="ii gt" jslog="20277; u014N:xr6bB; 4:W251bGwsbnVsbCxbXV0.">
            <div id=":pj" class="a3s aiL msg-1490284047881972777"><u></u>
                <div
                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    <a href="http://jetstream.test"
                                                        ...
                                                        target="_blank"
                                                        data-saferedirecturl="https://www.google.com/url?q=http://jetstream.test&amp;source=gmail&amp;ust=1635914934917000&amp;usg=AFQjCNE8Gb3SbAXtdf5nFTN-j2v2bp4AGA">
                                            ...
                                            <tr>
                                                <td width="100%" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <table class="m_-1490284047881972777inner-body" align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <font style="vertical-align: inherit;">
                                                                            <font style="vertical-align: inherit;">
                                                                                ...
                                                                                {{ $da['name'] }}
                                                                                <br>
                                                                                Thông báo sắp đến kì hạn của hợp đồng
                                                                                của bạn còn :
                                                                                                    ...
                                                                                                    <table border="0"
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            <tr>
                                                                                                                <td
                                                                                                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                                                                                                                    <a href="http://127.0.0.1:8000/api/contracts/edit/1"
                                                                                                                        class="m_-1490284047881972777button"
                                                                                                                        rel="noopener"
                                                                                                                        ...
                                                                                                                        target="_blank"
                                                                                                                        data-saferedirecturl="https://www.google.com/url?q=http://127.0.0.1:8000/register&amp;source=gmail&amp;ust=1635914934917000&amp;usg=AFQjCNHmU2eYfqmmoIBV-qMAEvpueBb6zw">
                                                                                                                        <font
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <font style="vertical-align: inherit;">
                                                                            <font style="vertical-align: inherit;">
                                                                                ...
                                                                                <b> Ngày tạo :
                                                                                    {{ $da['contract']['start_day'] }}</b>
                                                                                <br>
                                                                                <b> Ngày kết thúc :
                                                                                    {{ $da['contract']['end_day'] }}</b>
                                                                                <br>
                                                                                <b> Tên phòng :
                                                                                    {{ $da['contract']['room']->name }}</b>
                                                                                <br>
                                                                                <b> Tên tầng :
                                                                                    {{ $da['contract']['room']['floor']->name }}</b>
                                                                                <br>
                                                                                <b> Tên tòa nhà :
                                                                                    {{ $da['contract']['room']['floor']['building']->name }}</b>
                                                                                <br>
                                                                                <b> Tên dự án :
                                                                                    {{ $da['contract']['room']['floor']['building']['project']->name }}</b>
                                                                                <br>
                                                                            </font>
                                                                        </font>
                                                                    </p>
                                            ...
                                            <tr>
                                                <td
                                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                                                    <table class="m_-1490284047881972777footer" align="center"
                                                        width="570" cellpadding="0" cellspacing="0" role="presentation"
                                                                ...
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <font style="vertical-align: inherit;">
                                                                            <font style="vertical-align: inherit;">©
                                                                                2021 Laravel. </font>
                                                                            <font style="vertical-align: inherit;">Đã
                                                                                đăng ký Bản quyền.</font>
                                                                        </font>
                                                                    </p>
        ...
        <div id=":ox" class="ii gt" style="display:none">
            <div id=":oy" class="a3s aiL "></div>
        </div>
        <div class="hi"></div>
    </div>
</body>
