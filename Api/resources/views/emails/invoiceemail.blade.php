    ...
    <div class="invoice-body">
        ...
        <div class="invoice-header-top">
            ...
            <div class="invoice-right">
                ...
                <p class="invoice-right-bot">Sđt: 0911865212</p>
            </div>

        </div>
        <div class="invoice-header-bot ">
            <h2 style="float:left;margin:5px 50px 10px 0;">PHIẾU THU</h2>
            <h2 style="float:left;margin:5px 50px 10px 0;">THÁNG</h2>
        ...
        <div>
            <div class="invoice-infor-left">
                <p>Người thuê: <b></b></p>
                <p>Điện thoại: </p>
                <p>Loại thu phí: Dịch vụ phòng</p>
                    ...
                    <tbody>
                        @foreach ($data['invoice_details']['project_service_info'] as $projectService)
                            <tr>
                                ...
                                <td>{{ $projectService->index_calculated }}</td>
