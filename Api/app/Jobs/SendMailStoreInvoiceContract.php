...
class SendMailStoreInvoiceContract implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if (isset($this->data['invoice_details']['project_service_info']) && $this->data['invoice_details']['project_service_info'] != null) {
        ...
        $email = $this->data['invoice_details']['student_info']->email;
        try {
            Mail::to($email)->send(new SendInvoiceContractEmail($this->data));
